...
public class ValidatingTheLinks {
public static void main(String[] args) {
	...
	// getting the elements names of the Header Block and Validating the links of the Header Block
	...
	for(int index=0; index<headerBlockLinks_Count; index++) {
		...
		System.out.println(" The actual_WebpageUrlAddress after the links is called :-"+actual_WebpageUrlAddress);
		if(actual_WebpageUrlAddress.equals(expected_LinkUrlAddress)) 
		{
			System.out.println(" The actual Url Address Navigated to the link webpage Url Address - PASS");
		}
		else
		{
